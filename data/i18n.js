...
(function () {
  ...
  var STRINGS = {
    en: {
      ...
      nav_recipes: 'Recipes',
      recipes_title: 'Cook what you have',
      recipes_lede: 'Pick the ingredients in your kitchen and how much of each, choose a cuisine, and get a recipe built around exactly that. The nutrition is computed from the USDA data on this site, not from the model.',
      your_ingredients: 'Your ingredients', add_ingredient: 'Add an ingredient…',
      amount_g: 'Amount (g)', remove: 'Remove', cuisine: 'Cuisine', any_cuisine: 'No preference',
      servings: 'Servings', extra_instructions: 'Additional instructions',
      extra_hint: 'Anything you want respected — "no oven", "make it mild", "ready in 20 minutes", "I only have one pan". Edit this any time and regenerate.',
      generate: 'Create a recipe', regenerate: 'Regenerate', generating: 'Thinking…',
      basket_nutrition: 'What is in your basket',
      api_key: 'Gemini API key', api_key_set: 'Key saved on this device',
      api_key_missing: 'Add a Gemini API key to generate recipes',
      get_free_key: 'Get a free key from Google AI Studio',
    ...
    es: {
      ...
      nav_recipes: 'Recetas',
      recipes_title: 'Cocina con lo que tienes',
      recipes_lede: 'Elige los ingredientes que tienes en casa y cuánto de cada uno, escoge una cocina y recibe una receta hecha justo con eso. La nutrición se calcula con los datos del USDA de este sitio, no con el modelo.',
      your_ingredients: 'Tus ingredientes', add_ingredient: 'Añadir un ingrediente…',
      amount_g: 'Cantidad (g)', remove: 'Quitar', cuisine: 'Cocina', any_cuisine: 'Sin preferencia',
      servings: 'Raciones', extra_instructions: 'Instrucciones adicionales',
      extra_hint: 'Lo que quieras que se respete: «sin horno», «que sea suave», «listo en 20 minutos», «solo tengo una sartén». Puedes editarlo cuando quieras y volver a generar.',
      generate: 'Crear una receta', regenerate: 'Generar otra', generating: 'Pensando…',
      basket_nutrition: 'Lo que hay en tu cesta',
      api_key: 'Clave de API de Gemini', api_key_set: 'Clave guardada en este dispositivo',
      api_key_missing: 'Añade una clave de API de Gemini para generar recetas',
      get_free_key: 'Consigue una clave gratuita en Google AI Studio',
    ...
    hi: {
      ...
      nav_recipes: 'व्यंजन',
      recipes_title: 'जो है उसी से पकाएँ',
      recipes_lede: 'अपनी रसोई की सामग्री और उनकी मात्रा चुनें, पाक-शैली चुनें, और उसी के हिसाब से बनी विधि पाएँ। पोषण की गणना इस साइट के USDA आँकड़ों से होती है, मॉडल से नहीं।',
      your_ingredients: 'आपकी सामग्री', add_ingredient: 'सामग्री जोड़ें…',
      amount_g: 'मात्रा (ग्राम)', remove: 'हटाएँ', cuisine: 'पाक-शैली', any_cuisine: 'कोई भी',
      servings: 'कितने लोगों के लिए', extra_instructions: 'अतिरिक्त निर्देश',
      extra_hint: 'जो भी ध्यान रखना हो — «ओवन नहीं है», «कम तीखा», «20 मिनट में तैयार», «सिर्फ़ एक कड़ाही है»। इसे कभी भी बदलकर दोबारा बनवाएँ।',
      generate: 'विधि बनाएँ', regenerate: 'दोबारा बनाएँ', generating: 'सोच रहे हैं…',
      basket_nutrition: 'आपकी टोकरी में क्या है',
      api_key: 'Gemini API कुंजी', api_key_set: 'कुंजी इस डिवाइस पर सहेजी गई',
      api_key_missing: 'विधि बनाने के लिए Gemini API कुंजी जोड़ें',
      get_free_key: 'Google AI Studio से मुफ़्त कुंजी लें',
    ...
    kn: {
      ...
      nav_recipes: 'ಪಾಕವಿಧಾನ',
      recipes_title: 'ಇರುವುದರಿಂದಲೇ ಅಡುಗೆ',
      recipes_lede: 'ನಿಮ್ಮ ಅಡುಗೆಮನೆಯಲ್ಲಿರುವ ಪದಾರ್ಥಗಳನ್ನು ಮತ್ತು ಅವುಗಳ ಪ್ರಮಾಣವನ್ನು ಆರಿಸಿ, ಪಾಕಶೈಲಿ ಆರಿಸಿ, ಅದಕ್ಕೇ ತಕ್ಕ ವಿಧಾನ ಪಡೆಯಿರಿ. ಪೋಷಕಾಂಶವನ್ನು ಈ ತಾಣದ USDA ದತ್ತಾಂಶದಿಂದ ಲೆಕ್ಕಹಾಕಲಾಗುತ್ತದೆ, ಮಾದರಿಯಿಂದ ಅಲ್ಲ.',
      your_ingredients: 'ನಿಮ್ಮ ಪದಾರ್ಥಗಳು', add_ingredient: 'ಪದಾರ್ಥ ಸೇರಿಸಿ…',
      amount_g: 'ಪ್ರಮಾಣ (ಗ್ರಾಂ)', remove: 'ತೆಗೆದುಹಾಕಿ', cuisine: 'ಪಾಕಶೈಲಿ', any_cuisine: 'ಯಾವುದಾದರೂ',
      servings: 'ಎಷ್ಟು ಜನರಿಗೆ', extra_instructions: 'ಹೆಚ್ಚುವರಿ ಸೂಚನೆಗಳು',
      extra_hint: 'ಏನನ್ನು ಗಮನಿಸಬೇಕೋ ಅದನ್ನು ಬರೆಯಿರಿ — «ಒವನ್ ಇಲ್ಲ», «ಖಾರ ಕಡಿಮೆ», «20 ನಿಮಿಷದಲ್ಲಿ», «ಒಂದೇ ಬಾಣಲೆ». ಯಾವಾಗ ಬೇಕಾದರೂ ಬದಲಿಸಿ ಮತ್ತೆ ರಚಿಸಿ.',
      generate: 'ವಿಧಾನ ರಚಿಸಿ', regenerate: 'ಮತ್ತೆ ರಚಿಸಿ', generating: 'ಯೋಚಿಸುತ್ತಿದೆ…',
      basket_nutrition: 'ನಿಮ್ಮ ಬುಟ್ಟಿಯಲ್ಲಿ ಏನಿದೆ',
      api_key: 'Gemini API ಕೀ', api_key_set: 'ಕೀ ಈ ಸಾಧನದಲ್ಲಿ ಉಳಿಸಲಾಗಿದೆ',
      api_key_missing: 'ವಿಧಾನ ರಚಿಸಲು Gemini API ಕೀ ಸೇರಿಸಿ',
      get_free_key: 'Google AI Studio ನಿಂದ ಉಚಿತ ಕೀ ಪಡೆಯಿರಿ',
